...
(function($){
	...
	Page.prototype.setStyle=function(){
		...
		this.obj.children().css({'float':'left','margin':'0 '+marLR+'px','text-align':'center'});
		
		this.obj.find('a').css({'color':'#428bca','text-decoration':'none','border':'1px solid '+s.borderColor});
		this.obj.find('a').hover(function(){
　　　　$(this).css({'color':'#fff','background':'#428bca'});
}, function(){
　　　　$(this).css({'color':'#428bca','background':'#fff'});
});
		...
		this.obj.find('span.current').css({'display':'inline-block','height':s.height+'px','line-height':s.height+'px','color':s.currentColor,'vertical-align':'middle'});
		...
		this.obj.find('span.pagecount').css({'width':s.pagecountWidth+'px','font-size':s.fontSize+'px','color':'#555','height':s.height+'px','line-height':s.height+'px'});
		
		this.obj.find('span.countYe').css({'color':'#4C4C4C','font-size':s.fontSize+'px','width':s.trunWidth+'px'});

		this.obj.find('input').css({'outline':'none','border':'1px solid #ddd','height':s.height-2+'px','line-height':s.height-2+'px','width':'22px',margin: '0 5px'});
